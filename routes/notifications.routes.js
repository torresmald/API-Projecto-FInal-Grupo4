...
notificationRouter.post('/', [upload.single('image'), uploadToCloud], async (request, response, next) => {
    try {
        ...
        const newNotification = new Notification({ ...request.body, id: maxId, image: request.file_url });
